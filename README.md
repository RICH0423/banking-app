...
This project has been modernized to use Spring Boot 3.5 on the backend and Vue.js on the frontend. The original servlet and JSP implementation was replaced with REST APIs.
...
The Vue frontend is located in the `frontend` directory. Build it with:
```
...
4. Access the Application:
```
http://localhost:8081/banking-app
```

For containerized deployment on Kubernetes, use the manifests in the k8s directory.
